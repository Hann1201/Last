...
def run_media_propagation_simulation(frequency, wavelength, amplitude, er1, ur1, er2, ur2,
    ...
    try:
        ...
        ax1.set_xlabel('x (m)', fontsize=10, fontproperties=font_prop, labelpad=10)
        ax1.set_ylabel('H场', fontsize=10, fontproperties=font_prop, labelpad=10)
        ax1.set_zlabel('E场', fontsize=10, fontproperties=font_prop, labelpad=10)
