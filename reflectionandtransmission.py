...
def compute_media_params(lam0, er1, mur1, tand1, er2, mur2, tand2, theta_deg):
    """计算介质参数"""
    freq = c / lam0
    k0 = 2 * np.pi / lam0
    ...
    return (freq, k0, k1, k2, k1x, k2x, eta1, eta2, n1_c, n2_c,
            theta_t, r, t_coeff, lam1, lam2, n1_r, n2_r)
...
def get_three_waves_time(t, lam0, amp, er1, mur1, tand1, er2, mur2, tand2, theta_deg, bound=5.0):
    ...
    """
    (freq, k0, k1, k2, k1x, k2x, eta1, eta2, n1_c, n2_c,
     theta_t, r, t_coeff, lam1, lam2, n1_r, n2_r) = compute_media_params(
        lam0, er1, mur1, tand1, er2, mur2, tand2, theta_deg
    )
...
def generate_gif(theta_i_deg, n2, lam0, amp, er1, mur1, tand1, er2, mur2, tand2,
    ...
    # 计算介质参数用于显示
    (freq_p, k0, k1, k2, k1x, k2x, eta1, eta2, n1_c, n2_c,
     theta_t, r, t_coeff, lam1, lam2, n1_r, n2_r) = compute_media_params(
        lam0, er1, mur1, tand1, er2, mur2, tand2, theta_i_deg
    )
    ...
    return gif_buf, freq, theta_r_deg, theta_t_deg, r, t_coeff, total_ref, lam1, lam2
...
def run_reflection_simulation(theta_i_deg, n2, lam0, amp, er1, mur1, tand1, er2, mur2, tand2,
    ...
    try:
        ...
        if generate_animation:
            (gif_buf, freq, theta_r_deg, theta_t_deg, r, t_coeff, total_ref,
             lam1, lam2) = generate_gif(
...
**介质参数**
• 介质1: n1={np.real(np.sqrt(er1*mur1)):.2f}, εr={er1}, μr={mur1}, tanδ={tand1}
• 介质2: n2={n2:.2f}, εr={er2}, μr={mur2}, tanδ={tand2}
